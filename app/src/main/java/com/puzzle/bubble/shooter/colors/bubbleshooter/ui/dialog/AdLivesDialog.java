...
public class AdLivesDialog extends GameDialog implements View.OnClickListener, AdManager.AdRewardListener {
    ...
    public void onEarnReward() {
        ((MainActivity) this.mParent).getLivesTimer().addLive();
    }

...
public class ColorBubble extends BoosterBubble {
    ...
    public ColorBubble(BubbleSystem bubbleSystem, Game game) {
        ...
        this.mSparkleParticleSystem = new ParticleSystem(game, R.drawable.white_particle, 10).setDurationPerParticle(400).setSpeedX(-1000.0f, 1000.0f).setSpeedY(-1000.0f, 1000.0f).setInitialRotation(0, 360).setRotationSpeed(-720.0f, 720.0f).setAlpha(255.0f, 0.0f).setScale(1.0f, 0.5f).setLayer(this.mLayer - 1);
        ...
        this.mDotSystem.setDotBitmap(R.drawable.dot_white);
    }
    ...
    public void onBubbleHit(Bubble bubble) {
        if (this.mY >= bubble.mY && !this.mConsume) {
            Bubble newBubble = this.mBubbleSystem.getCollidedBubble(this, bubble);
    ...
    public boolean isColoredBubble(Bubble bubble) {
        return bubble.mBubbleColor == BubbleColor.BLUE || bubble.mBubbleColor == BubbleColor.RED || bubble.mBubbleColor == BubbleColor.YELLOW || bubble.mBubbleColor == BubbleColor.GREEN;
    }
